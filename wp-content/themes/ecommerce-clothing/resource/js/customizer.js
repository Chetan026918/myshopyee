...
(function($) {
    ...
    ecommerce_clothing_section_lists.forEach(ecommerce_clothing_homepage_scroll_preview);

    function ecommerce_clothing_homepage_scroll_preview(item, index) {
        ...
        wp.customize.bind('preview-ready', function() {
            ...
            wp.customize.preview.bind(item, function(data) {
                ...
                if (true === data.expanded) {
                    $('html, body').animate({
                        'scrollTop': $('#ecommerce_clothing_' + item + '_section').position().top
                    });
                }
            });
...
(function($) {
    wp.customize('ecommerce_clothing_enable_sticky_header', function(value) {
...
(function($) {
    wp.customize('ecommerce_clothing_enable_breadcrumb', function(value) {
        value.bind(function(newval) {
            if (newval) {
...
(function($) {
    wp.customize('ecommerce_clothing_website_layout', function(value) {
        value.bind(function(newval) {
            if (newval) {
...
(function($) {
    wp.customize('ecommerce_clothing_layout_width_margin', function(value) {
        value.bind(function(newval) {
...
( function( $ ) {
    wp.customize( 'ecommerce_clothing_sidebar_width', function( value ) {
        value.bind( function( newval ) {
