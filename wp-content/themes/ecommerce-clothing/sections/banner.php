<?php
if ( ! get_theme_mod( 'ecommerce_clothing_enable_banner_section', false ) ) {
	return;
}
...
for ( $i = 1; $i <= 3; $i++ ) {
	$ecommerce_clothing_slider_content_ids[] = get_theme_mod( 'ecommerce_clothing_banner_slider_content_' . $ecommerce_clothing_slider_content_type . '_' . $i );
}
			...
			if ( $ecommerce_clothing_query->have_posts() ) :
				...
				<div class="asterthemes-banner-wrapper banner-slider ecommerce-clothing-carousel-navigation" data-slick='{"autoplay": false }'>
					...
					while ( $ecommerce_clothing_query->have_posts() ) :
						...
						$ecommerce_clothing_button_label = get_theme_mod( 'ecommerce_clothing_banner_button_label_' . $i, '' );
						$ecommerce_clothing_button_link  = get_theme_mod( 'ecommerce_clothing_banner_button_link_' . $i, '' );
