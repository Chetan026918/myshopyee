...
for ( $i = 1; $i <= 3; $i++ ) {
	...
	$wp_customize->add_setting(
		'ecommerce_clothing_banner_slider_content_post_' . $i,
		array(
	...
	$wp_customize->add_control(
		'ecommerce_clothing_banner_slider_content_post_' . $i,
		array(
			'label'           => sprintf( esc_html__( 'Select Post %d', 'ecommerce-clothing' ), $i ),
			'section'         => 'ecommerce_clothing_banner_section',
			'settings'        => 'ecommerce_clothing_banner_slider_content_post_' . $i,
	...
	$wp_customize->add_setting(
		'ecommerce_clothing_banner_slider_content_page_' . $i,
		array(
			'sanitize_callback' => 'absint',
		)
	);
	...
	$wp_customize->add_control(
		'ecommerce_clothing_banner_slider_content_page_' . $i,
		array(
			'label'           => sprintf( esc_html__( 'Select Page %d', 'ecommerce-clothing' ), $i ),
			'section'         => 'ecommerce_clothing_banner_section',
			'settings'        => 'ecommerce_clothing_banner_slider_content_page_' . $i,
	...
	$wp_customize->add_setting(
		'ecommerce_clothing_banner_button_label_' . $i,
		array(
			'default'           => '',
	...
	$wp_customize->add_control(
		'ecommerce_clothing_banner_button_label_' . $i,
		array(
			'label'           => sprintf( esc_html__( 'Button Label %d', 'ecommerce-clothing' ), $i ),
			'section'         => 'ecommerce_clothing_banner_section',
			'settings'        => 'ecommerce_clothing_banner_button_label_' . $i,
			'type'            => 'text',
			'active_callback' => 'ecommerce_clothing_is_banner_slider_section_enabled',
		)
	);
	...
	$wp_customize->add_setting(
		'ecommerce_clothing_banner_button_link_' . $i,
		array(
			'default'           => '',
	...
	$wp_customize->add_control(
		'ecommerce_clothing_banner_button_link_' . $i,
		array(
			'label'           => sprintf( esc_html__( 'Button Link %d', 'ecommerce-clothing' ), $i ),
			'section'         => 'ecommerce_clothing_banner_section',
			'settings'        => 'ecommerce_clothing_banner_button_link_' . $i,
			'type'            => 'url',
			'active_callback' => 'ecommerce_clothing_is_banner_slider_section_enabled',
		)
	);
