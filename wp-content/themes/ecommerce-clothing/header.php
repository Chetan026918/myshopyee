 ...
 */
$ecommerce_clothing_menu_text_transform = get_theme_mod( 'menu_text_transform', 'capitalize' );
...
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'ecommerce-clothing' ); ?></a>
	 <?php
	if ( get_theme_mod( 'ecommerce_clothing_enable_preloader', false ) === true ) { ?>
		<div id="loader">
...
<header id="masthead" class="site-header">
    <div class="header-main-wrapper">
        <?php if ( get_theme_mod( 'ecommerce_clothing_enable_topbar', false ) === true ) {
